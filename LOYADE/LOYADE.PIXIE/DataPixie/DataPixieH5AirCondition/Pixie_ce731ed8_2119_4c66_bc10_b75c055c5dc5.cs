...
{
    public class PIXIE_ce731ed8_2119_4c66_bc10_b75c055c5dc5 : Pixie
    {
        public PIXIE_ce731ed8_2119_4c66_bc10_b75c055c5dc5()
        { 
...
listpt = new List<Point>();sb = new SolidBrush(_listfillcolor[2]);p = new Pen(Color.Black);p.Width = _listborderwidth[2];p.Color = _listbordercolor[2];g.FillEllipse(sb, 70f,69f,124f,124f);g.DrawEllipse(p, 70f,69f,124f,124f);
        }
    }
}