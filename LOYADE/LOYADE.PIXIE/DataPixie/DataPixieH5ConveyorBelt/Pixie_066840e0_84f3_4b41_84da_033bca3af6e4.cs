...
{
    public class PIXIE_066840e0_84f3_4b41_84da_033bca3af6e4 : Pixie
    {
        public PIXIE_066840e0_84f3_4b41_84da_033bca3af6e4()
        { 
...
_w = 499f; _h = 546f;
_content = "var arrFillColor = new Array(1); var arrBorderColor = new Array(1); var arrBorderWidth = new Array(1); arrFillColor[0] = '#c0c0c0'; arrBorderColor[0] = '#000'; arrBorderWidth[0] = '2'; ctx.beginPath(); /* path */ ctx.moveTo(499,15);ctx.lineTo(125,15);ctx.lineTo(118,88);ctx.lineTo(96,159);ctx.lineTo(62,223);ctx.lineTo(15,281);ctx.lineTo(280,546);ctx.lineTo(373,430);ctx.lineTo(441,302);ctx.lineTo(485,161);ctx.lineTo(499,15);ctx.fillStyle = arrFillColor[0];ctx.fill();ctx.lineWidth = arrBorderWidth[0];ctx.strokeStyle = arrBorderColor[0];ctx.stroke();ctx.closePath();";
        }
