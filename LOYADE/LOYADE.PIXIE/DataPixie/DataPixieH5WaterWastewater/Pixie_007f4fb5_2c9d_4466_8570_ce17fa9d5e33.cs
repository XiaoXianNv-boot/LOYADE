...
{
    public class PIXIE_007f4fb5_2c9d_4466_8570_ce17fa9d5e33 : Pixie
    {
        public PIXIE_007f4fb5_2c9d_4466_8570_ce17fa9d5e33()
        { 
...
listpt = new List<Point>();p = new Pen(Color.Black);p.Width = _listborderwidth[0];p.Color = _listbordercolor[0];g.DrawEllipse(p, 9.9123f,19f,226f,226f);
