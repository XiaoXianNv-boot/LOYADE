...
namespace LOYADE.IOCP
{
    public class LogOutputSocketProtocol : BaseSocketProtocol
    {
            ...
            : base(asyncSocketServer, asyncSocketUserToken)
        {
            ...
            lock (__Global.AsyncSocketSvr.LogOutputSocketProtocolMgr)
            {
                __Global.AsyncSocketSvr.LogOutputSocketProtocolMgr.Add(this);
            }
        ...
        public override void Close()
        {
            lock (__Global.AsyncSocketSvr.LogOutputSocketProtocolMgr)
            {
                __Global.AsyncSocketSvr.LogOutputSocketProtocolMgr.Remove(this);
            }
        }
    ...
    class LogSocketAppender : log4net.Appender.AppenderSkeleton
    {
        ...
        protected override void Append(LoggingEvent loggingEvent)
        {
            ...
            lock (__Global.AsyncSocketSvr.LogOutputSocketProtocolMgr)
            {
                for (int i = 0; i < __Global.AsyncSocketSvr.LogOutputSocketProtocolMgr.Count(); i++)
                {
                    __Global.AsyncSocketSvr.LogOutputSocketProtocolMgr.ElementAt(i).LogFixedBuffer.WriteBuffer(tmpBuffer);
                    __Global.AsyncSocketSvr.LogOutputSocketProtocolMgr.ElementAt(i).InitiativeSend();
                }
            }
        }
    }
