...
{
    public class ActionDBMSSQL : ActionDBSQL
    {
        public override string TestConnection(string key)
        {
            ...
            try
            {
                SqlConnection conn = new SqlConnection(base.Connections[key].Value.ToString());
                conn.Open();
                conn.Close();
            }
            catch (Exception ex)
        ...
        public override string GetDataSetXMLBySQL(string sql)
        {
            ...
            SqlConnection.ClearAllPools();
            using (SqlConnection conn = new SqlConnection(base.Connections[base.CurrentConnectionKey].Value.ToString()))
            {
                conn.Open();
        ...
        {
            if (connobj != null && connobj is SqlConnection)
            {
                SqlConnection conn = connobj as SqlConnection;
                conn.Close();
            }
        }
        ...
        public override int OperateByScript(string script)
        {
            int iRet = 0;
            SqlConnection.ClearAllPools();
            using (SqlConnection conn = new SqlConnection(base.Connections[base.CurrentConnectionKey].Value.ToString()))
            {
                try
                {
                    ...
                    iRet = server.ConnectionContext.ExecuteNonQuery(script);
                }
                catch (Exception ex)
                {
                    ExceptionInfo = ex.Message;
        ...
        public override int OperateByScriptWithConnectionOpen(string script, object connobj)
        {
            int iRet = 0;
            if (connobj != null && connobj is SqlConnection)
            {
        ...
        public override int OperateByTransaction(string[] arrsql)
        {
            ...
            using (SqlConnection conn = new SqlConnection(base.Connections[base.CurrentConnectionKey].Value.ToString()))
            {
                ...
                {
                    ExceptionInfo = ""; conn.Open();
                    SqlTransaction vt = conn.BeginTransaction();
                    SqlCommand cmd = new SqlCommand();
                    cmd.Connection = conn;
                    cmd.Transaction = vt;
        ...
        public override void OperateBySQLBulkCopy(string targetdt, DataTable dtsource)
        {
            SqlConnection.ClearAllPools();
            string connstr = base.Connections[base.CurrentConnectionKey].Value.ToString();
            using (SqlConnection conn = new SqlConnection(connstr))
            {
                using (SqlBulkCopy sqlbulkcopy = new SqlBulkCopy(connstr, SqlBulkCopyOptions.UseInternalTransaction))
                {
                    try
                    {
                        sqlbulkcopy.DestinationTableName = targetdt;
        ...
        public override void OperateBySQLBulkCopy(string targetdt, DataTable dtsource, Dictionary<string, string> dictargetcolumns)
        {
            SqlConnection.ClearAllPools();
            string connstr = base.Connections[base.CurrentConnectionKey].Value.ToString();
            using (SqlConnection conn = new SqlConnection(connstr))
            {
                using (SqlBulkCopy sqlbulkcopy = new SqlBulkCopy(connstr, SqlBulkCopyOptions.UseInternalTransaction))
                {
                    ...
                    try
                    {
                        ...
                        foreach (DataColumn dc in dtsource.Columns)
                        {
                            sqlbulkcopy.ColumnMappings.Add(dc.ColumnName, dictargetcolumns[dc.ColumnName]);
                        }
                        sqlbulkcopy.WriteToServer(dtsource);
                    }
                    catch (Exception ex)
