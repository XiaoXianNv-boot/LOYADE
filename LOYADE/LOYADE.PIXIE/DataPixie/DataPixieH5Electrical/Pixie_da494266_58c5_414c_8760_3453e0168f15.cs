...
{
    public class PIXIE_da494266_58c5_414c_8760_3453e0168f15 : Pixie
    {
        public PIXIE_da494266_58c5_414c_8760_3453e0168f15()
        { 
...
_w = 482f; _h = 482f;
_content = "var arrFillColor = new Array(1); var arrBorderColor = new Array(3); var arrBorderWidth = new Array(3); arrFillColor[0] = '#0ff'; arrBorderColor[0] = '#000'; arrBorderColor[1] = '#000'; arrBorderColor[2] = '#000'; arrBorderWidth[0] = '2'; arrBorderWidth[1] = '2'; arrBorderWidth[2] = '2'; ctx.beginPath(); /* path */ ctx.moveTo(14,249);ctx.lineTo(247,14);ctx.lineTo(482,249);ctx.lineTo(248,482);ctx.lineTo(14,249);ctx.fillStyle = arrFillColor[0];ctx.fill();ctx.lineWidth = arrBorderWidth[0];ctx.strokeStyle = arrBorderColor[0];ctx.stroke();ctx.closePath();ctx.beginPath(); /* circle */ ctx.arc(413,248,29,0,Math.PI*2,true);ctx.lineWidth = arrBorderWidth[1];ctx.strokeStyle = arrBorderColor[1];ctx.stroke();ctx.closePath();ctx.beginPath(); /* circle */ ctx.arc(82,248,29,0,Math.PI*2,true);ctx.lineWidth = arrBorderWidth[2];ctx.strokeStyle = arrBorderColor[2];ctx.stroke();ctx.closePath();";
        }
...
listpt = new List<Point>();listpt.Add(new Point(14,249));listpt.Add(new Point(247,14));listpt.Add(new Point(482,249));listpt.Add(new Point(248,482));listpt.Add(new Point(14,249));sb = new SolidBrush(_listfillcolor[0]);p = new Pen(Color.Black);p.Width = _listborderwidth[0];p.Color = _listbordercolor[0];g.FillPolygon(sb, listpt.ToArray());g.DrawPolygon(p, listpt.ToArray());
