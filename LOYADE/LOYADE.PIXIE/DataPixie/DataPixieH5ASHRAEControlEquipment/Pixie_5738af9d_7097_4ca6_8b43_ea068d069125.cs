...
{
    public class PIXIE_5738af9d_7097_4ca6_8b43_ea068d069125 : Pixie
    {
        public PIXIE_5738af9d_7097_4ca6_8b43_ea068d069125()
        { 
...
listpt = new List<Point>();listpt.Add(new Point(28,263));listpt.Add(new Point(499,263));listpt.Add(new Point(499,735));listpt.Add(new Point(28,735));listpt.Add(new Point(28,263));sb = new SolidBrush(_listfillcolor[1]);p = new Pen(Color.Black);p.Width = _listborderwidth[1];p.Color = _listbordercolor[1];g.FillPolygon(sb, listpt.ToArray());g.DrawPolygon(p, listpt.ToArray());
listpt = new List<Point>();p = new Pen(Color.Black);p.Width = _listborderwidth[2];p.Color = _listbordercolor[2];g.DrawEllipse(p, 216f,616f,94f,94f);
        }
    }
}