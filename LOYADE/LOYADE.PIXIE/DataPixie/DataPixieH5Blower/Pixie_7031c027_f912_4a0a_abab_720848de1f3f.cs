...
{
    public class PIXIE_7031c027_f912_4a0a_abab_720848de1f3f : Pixie
    {
        public PIXIE_7031c027_f912_4a0a_abab_720848de1f3f()
        { 
...
listpt = new List<Point>();listpt.Add(new Point(665,901));listpt.Add(new Point(556,931));listpt.Add(new Point(442,931));listpt.Add(new Point(333,901));listpt.Add(new Point(235,844));listpt.Add(new Point(154,765));listpt.Add(new Point(95,665));listpt.Add(new Point(67,556));listpt.Add(new Point(67,442));listpt.Add(new Point(97,331));listpt.Add(new Point(154,233));listpt.Add(new Point(233,154));listpt.Add(new Point(333,95));listpt.Add(new Point(442,67));listpt.Add(new Point(556,67));listpt.Add(new Point(667,95));listpt.Add(new Point(765,154));listpt.Add(new Point(844,233));listpt.Add(new Point(903,331));listpt.Add(new Point(931,442));listpt.Add(new Point(931,556));listpt.Add(new Point(903,665));listpt.Add(new Point(844,765));listpt.Add(new Point(765,844));listpt.Add(new Point(665,901));sb = new SolidBrush(_listfillcolor[0]);p = new Pen(Color.Black);p.Width = _listborderwidth[0];p.Color = _listbordercolor[0];g.FillPolygon(sb, listpt.ToArray());g.DrawPolygon(p, listpt.ToArray());
